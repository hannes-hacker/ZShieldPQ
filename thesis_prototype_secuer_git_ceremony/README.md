# Description
This directory represents the implementation of the section "The Ceremony" in the paper.

The implementation is divided into three repositories utilizing Git technology:
Participants’ access on GitHub, CI pipeline on Gitlab
and secure value storage on Gitlab according to the architecture provided in the paper.
...
repository in Gitlab: "Settings/Access tokens" with "write_repository" permissions.
...
Besides, it stores a reliable and safe instance of the SECUER tools (https://github.com/trusted-isogenies/SECUER-pok/) which are built and utilized by the scripts to utilized a trustworthy instance of the original SECUER protocol project.
...
After placing the initial curve and proof (like described in "Participants’ access on GitHub") in the according directories, 
