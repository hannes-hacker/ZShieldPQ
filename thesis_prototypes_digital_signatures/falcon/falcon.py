...
class SecretKey:
    ...
    def hash_to_point(self, message, salt, hashfunc=SHAKE256):
        """
        ...
        shake = hashfunc.new() # Changed for benchmarking the influence different XOF algorithms - default: SHAKE256
        shake.update(salt)
    ...
    def sign(self, message, randombytes=urandom, hashfunc=SHAKE256):
        """
        ...
        hashed = self.hash_to_point(message, salt, hashfunc)
    ...
    def verify(self, message, signature, hashfunc=SHAKE256):
        """
        Verify a signature.
        """
    ...
    def sign_recoverable(self, message, randombytes=urandom, hashfunc=SHAKE256):
    ...
    # Extract information out of signature.
    ...
    def recover(self, message, signature, hashfunc=SHAKE256):
        ...
        # public key = s2^(-1)(HashToPoint(r||m, q, n) - s1)
        hashtopoint = self.hash_to_point(message, salt, hashfunc)
